# -*- coding: utf-8 -*-
"""L21-L25 浏览器实测：L21 逐页点测 + L22-25 抽查新题型，验证无黑屏/函数定义/答题落 IndexedDB"""
import json
...
json.dump(report, open(r"D:\英语教学\00_工具\_browser_L21_25_report.json","w",encoding="utf-8"),ensure_ascii=False,indent=1)
print("\nSaved browser report to D:\\英语教学\\00_工具\\_browser_L21_25_report.json")